...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user && $user['role'] === 'doctor' && password_verify($password, $user['password'])) {
...
<head>
    ...
    <title>OptiClinic — Espace Médecin</title>
...
<div class="login-page-wrapper">
    ...
    <div class="container d-flex justify-content-center">
        <div class="login-card">
            ...
            <div class="login-card-icon doctor">
                <i class="fas fa-user-md"></i>
            </div>

            <h3>Connexion</h3>
            <span class="login-role-tag"><i class="fas fa-circle me-1" style="font-size:.5rem"></i>Espace Médecin</span>
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="docteur@opticlinic.tn" required>
                    </div>
                </div>
                <div class="mb-3">
            ...
            <div class="login-back-link">
                Réceptionniste ? <a href="../receptionist/login.php">Connexion espace réceptionniste</a>
            </div>
        </div>
    </div>
</div>
